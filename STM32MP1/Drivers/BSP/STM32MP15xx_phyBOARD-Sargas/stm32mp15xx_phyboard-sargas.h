/**
  ******************************************************************************
  * @file    stm32mp15xx_phyboard-sargas.h
  * @author  c.parant@phytec.fr
  * @brief   This file contains definitions for phyBOARD-Sargas LEDs,
...
#ifndef __STM32MP15XX_PHYBOARD_H
#define __STM32MP15XX_PHYBOARD_H
...
#include "stm32mp15xx_phyboard-sargas_conf.h"
#include "stm32mp15xx_phyboard_errno.h"
   
/** @addtogroup BSP
  * @{
  */

/** @addtogroup STM32MP15XX_PHYBOARD STM32MP15XX_PHYBOARD
  * @{
  */

/** @defgroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Exported_Types Exported Types
  * @{
  */
...
/** @defgroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Exported_Constants Exported Constants
  * @{
  */ 

/** 
  * @brief  Define for STM32MP15XX_PHYBOARD board
  */ 
#if !defined (USE_STM32MP15XX_PHYBOARD)
 #define USE_STM32MP15XX_PHYBOARD
#endif
...
/**
  ...
  */
  ...
  /** @addtogroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Exported_Constants Exported Constants
  * @{
  */

/** @addtogroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Exported_Constants_Group1 LED Constants
  * @{
  */
...
/** @addtogroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Exported_Constants_Group2 BUTTON Constants
  * @{
  */ 
...
/** @addtogroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Exported_Constants_Group3 COM Constants
  * @{
  */
...
#define COM1_RX_AF                    GPIO_AF8_USART3
...
/** @defgroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Exported_Functions Exported Functions
  * @{
  */
...
#endif /* __STM32MP15XX_PHYBOARD_H */
