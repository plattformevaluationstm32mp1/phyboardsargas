/**
  ******************************************************************************
  * @file    stm32mp15xx_phyboard-sargas.c
  * @author  c.parant@phytec.fr
  * @brief   This file provides a set of firmware functions to manage LEDs, 
  *          push-buttons and COM ports available on phyBOARD-Sargas evaluation
  *          board from PHYTEC (equipped with phyCORE-STM32MP1 SOM).
  *
  @verbatim
  *
  @endverbatim
...
/* Includes ------------------------------------------------------------------*/
#include "stm32mp15xx_phyboard-sargas.h"

/** @addtogroup BSP
  * @{
  */ 

/** @addtogroup STM32MP15XX_PHYBOARD
  * @{
  */

/** @defgroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Private_TypesDefinitions Private Typedef
  * @{
  */
...
/** @defgroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Private_Defines Private Def
  * @{
  */

/** @brief STM32MP15XX PHYBOARD BSP Driver version number V2.0.0
  */
#define STM32MP15XX_PHYBOARD_BSP_VERSION_MAIN   (0x01U) /*!< [31:24] main version */
#define STM32MP15XX_PHYBOARD_BSP_VERSION_SUB1   (0x05U) /*!< [23:16] sub1 version */
#define STM32MP15XX_PHYBOARD_BSP_VERSION_SUB2   (0x00U) /*!< [15:8]  sub2 version */
#define STM32MP15XX_PHYBOARD_BSP_VERSION_RC     (0x00U) /*!< [7:0]  release candidate */
#define STM32MP15XX_PHYBOARD_BSP_VERSION         ((STM32MP15XX_PHYBOARD_BSP_VERSION_MAIN << 24)\
                                             |(STM32MP15XX_PHYBOARD_BSP_VERSION_SUB1 << 16)\
                                             |(STM32MP15XX_PHYBOARD_BSP_VERSION_SUB2 << 8 )\
                                             |(STM32MP15XX_PHYBOARD_BSP_VERSION_RC))
/**
  * @}
  */


/** @defgroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Private_Variables Private Variables
  * @{
  */

static GPIO_TypeDef* LED_PORT[LEDn] = {LED1_GPIO_PORT, /* Green LED on SOM */
                                       LED2_GPIO_PORT}; /* Red LED on SOM */
...
/** @defgroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Private_FunctionPrototypes Private Prototypes
  * @{
  */
#ifdef HAL_EXTI_MODULE_ENABLED
...
/** @addtogroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Exported_Functions Exported Functions
  * @{
  */ 

  /**
  * @brief  This method returns the STM32MP15XX PHYBOARD BSP Driver revision
  * @retval version: 0xXYZR (8bits for each decimal, R for RC)
  */
uint32_t BSP_GetVersion(void)
{
  return STM32MP15XX_PHYBOARD_BSP_VERSION;
}

/** @addtogroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Exported_Functions_Group1 LED Functions
  * @{
  */
/**
...
/** @addtogroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Exported_Functions_Group2 BUTTON Functions
  * @{
  */
...
#if (USE_BSP_COM_FEATURE == 1)
/** @addtogroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Exported_Functions_Group3 COM Functions
  * @{
  */
/**
...
int32_t BSP_COM_Init(COM_TypeDef COM, COM_InitTypeDef *COM_Init)
{
  ...
  else
  {
    ...
    if(MX_USART3_Init(&hComHandle[COM], COM_Init) != HAL_OK)
    {
...
/**
  ...
  */
__weak HAL_StatusTypeDef MX_USART3_Init(UART_HandleTypeDef *huart, COM_InitTypeDef *COM_Init)
{
  /* USART configuration */
...
/** @addtogroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Private_Functions Private Functions
  * @{
  */ 
  
/** @addtogroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Private_Functions_Group1 BUTTON Functions
  * @{
  */
...
#if (USE_BSP_COM_FEATURE == 1)
#ifdef HAL_UART_MODULE_ENABLED
/** @addtogroup STM32MP15XX_PHYBOARD_LOW_LEVEL_Private_Functions_Group2 COM Functions
  * @{
  */
/**
